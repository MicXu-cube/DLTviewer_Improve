...
{
#ifdef XWBLOG
    qDebug() << "xwb:SearchDialog::setSearchColour searchresult =" << result << __FILE__ << __LINE__;
#endif
...
{
#ifdef XWBLOG
    qDebug() << "xwb:SearchDialog::focusRow before " << __FILE__ << __LINE__;
#endif
    ...
    model->modelChanged();
#ifdef XWBLOG
    qDebug() << "xwb:SearchDialog::focusRow after " << __FILE__ << __LINE__;
#endif
}
...
{
#ifdef XWBLOG
    qDebug() << "xwb:SearchDialog::find before " << __FILE__ << __LINE__;
#endif
...
#ifdef XWBLOG
    qDebug() << "xwb:SearchDialog::find match = "<< match << "getSearchFromBeginning()" << getSearchFromBeginning() << "searchtoIndex()" << searchtoIndex() << __FILE__ << __LINE__;
#endif
   ...
   else
   {
    ...
    {
#ifdef XWBLOG
    qDebug() << "xwb:SearchDialog::find Start from the beginning " << __FILE__ << __LINE__;
#endif
...
#ifdef XWBLOG
    qDebug() << "xwb:SearchDialog::find Start find-Messages process" << __FILE__ << __LINE__;
#endif
...
#ifdef XWBLOG
    qDebug() << "xwb:SearchDialog::find after match = " << match << __FILE__ << __LINE__;
#endif
    if(match == true )
    {
        return 1;
...
{
#ifdef XWBLOG
    qDebug() << "xwb:SearchDialog::findMessages before " << __FILE__ << __LINE__;
    qDebug() << "xwb:SearchDialog::findMessages searchLine = "<< searchLine << "searchBorder" << searchBorder << __FILE__ << __LINE__;
#endif
    ...
    do
    {
        ...
        text.clear();
//#ifdef XWBLOG
//    qDebug() << "xwb:SearchDialog::findMessages searchLine = "<< searchLine << "searchBorder" << searchBorder;
//#endif
        if(getNextClicked() || searchtoIndex())
        {
            searchLine++;
    ...
    stoptime();
#ifdef XWBLOG
    qDebug() << "xwb:SearchDialog::findMessages after" << __FILE__ << __LINE__;
#endif
}
...
void SearchDialog::on_pushButtonNext_clicked() // connected to main window line 424
{
    ...
    int result = find();
#ifdef XWBLOG
    qDebug() << "xwb:SearchDialog::on_pushButtonNext_clicked searchresult =" << result << __FILE__ << __LINE__;
#endif
...
void SearchDialog::on_pushButtonPrevious_clicked()
{
    ...
    int result = find();
#ifdef XWBLOG
    qDebug() << "xwb:SearchDialog::on_pushButtonPrevious_clicked searchresult =" << result << __FILE__ << __LINE__;
#endif
    for(int i=0; i<lineEdits->size();i++)
    {
       setSearchColour(lineEdits->at(i),result);
...
void SearchDialog::findNextClicked()
{
    ...
    int result = find();
#ifdef XWBLOG
    qDebug() << "xwb:SearchDialog::findNextClicked searchresult =" << result << __FILE__ << __LINE__;
#endif
    for(int i=0; i<lineEdits->size();i++)
    {
       setSearchColour(lineEdits->at(i),result);
...
void SearchDialog::findPreviousClicked()
{
    ...
    int result = find();
#ifdef XWBLOG
    qDebug() << "xwb:SearchDialog::findPreviousClicked searchresult =" << result << __FILE__ << __LINE__;
#endif
    for(int i=0; i<lineEdits->size();i++){
       setSearchColour(lineEdits->at(i),result);
    }
...
{
#ifdef XWBLOG
    qDebug() << "xwb:SearchDialog::updateColorbutton before " << __FILE__ << __LINE__;
#endif
    QString color = QDltSettingsManager::getInstance()->value("other/searchResultColor", QString("#00AAFF")).toString();
...
#ifdef XWBLOG
    qDebug() << "xwb:SearchDialog::updateColorbutton after " << __FILE__ << __LINE__;
#endif
}
