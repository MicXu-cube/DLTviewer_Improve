...
#ifdef XWBLOG
    qDebug() << "xwb:mainwindow init before" << __FILE__ << __LINE__;
#endif
    initState();
...
#ifdef XWBLOG
    qDebug() << "xwb:mainwindow init after" << __FILE__ << __LINE__;
#endif
...
#ifdef XWBLOG
    qDebug() << "xwb: recentFiles size" << recentFiles.size() << __FILE__ << __LINE__;
    qDebug() << "xwb: recentProjects size" << recentProjects.size() << __FILE__ << __LINE__;
    qDebug() << "xwb: recentFilters size" << recentFilters.size() << __FILE__ << __LINE__;
#endif
...
{
#ifdef XWBLOG
    qDebug() << "xwb:mainwindow initView before" << __FILE__ << __LINE__;
#endif
    int maxWidth = 0;
...
//    ui->exploreView->setContextMenuPolicy(Qt::CustomContextMenu);
    ...
    /* this deal will open treewidget show */
...
//    }
    ...
    updateScrollButton();
#ifdef XWBLOG
    qDebug() << "xwb:mainwindow initView after" << __FILE__ << __LINE__;
#endif
}
...
{
#ifdef XWBLOG
    qDebug() << "xwb:mainwindow initSignalConnections before" << __FILE__ << __LINE__;
#endif
...
#ifdef XWBLOG
    qDebug() << "xwb:mainwindow initSignalConnections after" << __FILE__ << __LINE__;
#endif
}
...
{
#ifdef XWBLOG
    qDebug() << "xwb:mainwindow initSearchTable before" << __FILE__ << __LINE__;
#endif
    //init search Dialog
...
#ifdef XWBLOG
    qDebug() << "xwb:mainwindow initSearchTable after" << __FILE__ << __LINE__;
#endif
}
...
{
#ifdef XWBLOG
    qDebug() << "xwb:mainwindow::initFileHandling before" << __FILE__ << __LINE__;
#endif
...
#ifdef XWBLOG
    qDebug() << "xwb:mainwindow::initFileHandling isProjectFile = " << QDltOptManager::getInstance()->isProjectFile() << __FILE__ << __LINE__;
    qDebug() << "xwb:mainwindow::initFileHandling defaultProjectFile = " << settings->defaultProjectFile << __FILE__ << __LINE__;
#endif
...
#ifdef XWBLOG
    qDebug() << "xwb:mainwindow::initFileHandling isLogFile = " << QDltOptManager::getInstance()->isLogFile() << __FILE__ << __LINE__;
    qDebug() << "xwb:mainwindow::initFileHandling defaultLogFile = " << settings->defaultLogFile << __FILE__ << __LINE__;
#endif
...
#ifdef XWBLOG
    qDebug() << "xwb:mainwindow initFileHandling after" << __FILE__ << __LINE__;
#endif
}
...
{
#ifdef XWBLOG
    qDebug() << "xwb:mainwindow commandLineConvertToDLT before" << __FILE__ << __LINE__;
#endif
...
{
#ifdef XWBLOG
    qDebug() << "xwb:mainwindow commandLineConvertToASCII before" << __FILE__ << __LINE__;
#endif
...
{
#ifdef XWBLOG
    qDebug() << "xwb:mainwindow commandLineConvertToCSV before" << __FILE__ << __LINE__;
#endif
...
{
#ifdef XWBLOG
    qDebug() << "xwb:mainwindow commandLineConvertToUTF8 before" << __FILE__ << __LINE__;
#endif
...
{
#ifdef XWBLOG
    qDebug() << "xwb:mainwindow::commandLineConvertToDLTDecoded before" << __FILE__ << __LINE__;
#endif
    qfile.enableFilter(true);
    openDltFile(QStringList(QDltOptManager::getInstance()->getConvertSourceFile()));
    outputfileIsFromCLI = false;
...
#ifdef XWBLOG
    qDebug() << "xwb:mainwindow::commandLineConvertToDLTDecoded after" << __FILE__ << __LINE__;
#endif
}
...
{
#ifdef XWBLOG
    qDebug() << "xwb:MainWindow::onNewTriggered before";
#endif
...
#ifdef XWBLOG
    qDebug() << "xwb:MainWindow::onNewTriggered after";
#endif
}
...
{
#ifdef XWBLOG
    qDebug() << "xwb:mainwindow::on_action_menuFile_Open_triggered before" << __FILE__ << __LINE__;
#endif
...
#ifdef XWBLOG
    qDebug() << "xwb:mainwindow::on_action_menuFile_Open_triggered after" << __FILE__ << __LINE__;
#endif
}
...
{
#ifdef XWBLOG
    qDebug() << "xwb:mainwindow::onOpenTriggered before" << __FILE__ << __LINE__;
#endif
    /* change DLT file working directory */
...
#ifdef XWBLOG
    qDebug() << "xwb:mainwindow::onOpenTriggered after" << __FILE__ << __LINE__;
#endif
}
...
{
#ifdef XWBLOG
    qDebug() << "xwb:mainwindow::openRecentFile before" << __FILE__ << __LINE__;
#endif
...
#ifdef XWBLOG
    qDebug() << "xwb:mainwindow::openRecentFile after" << __FILE__ << __LINE__;
#endif
}
...
{
#ifdef XWBLOG
    qDebug() << "xwb:MainWindow::openDltFile before. filesize =" << fileNames.size();
#endif
    /* close existing file */
    bool ret = false;
...
#ifdef XWBLOG
    qDebug() << "xwb:MainWindow::openDltFile. isopen =" << outputfile.isOpen();
    qDebug() << "xwb:MainWindow::openDltFile. isopen =" << outputfile.size();
#endif
    ...
    {
#ifdef XWBLOG
    qDebug() << "xwb:MainWindow::openDltFile open = true" << __FILE__ << __LINE__;
#endif
    ...
    {
#ifdef XWBLOG
    qDebug() << "xwb:MainWindow::openDltFile open = false" << __FILE__ << __LINE__;
#endif
...
#ifdef XWBLOG
    qDebug() << "xwb:MainWindow::openDltFile ret = " << ret;
#endif

    if (ret)
        emit dltFileLoaded(fileNames);
#ifdef XWBLOG
    qDebug() << "xwb:MainWindow::openDltFile after";
#endif
...
{
#ifdef XWBLOG
    qDebug() << "xwb:MainWindow::exportSelection_searchTable before";
#endif
...
#ifdef XWBLOG
    qDebug() << "xwb:MainWindow::exportSelection_searchTable after";
#endif
}
...
{
#ifdef XWBLOG
    qDebug() << "xwb:MainWindow::onSaveAsTriggered before";
#endif
    ...
    if(outputfile.open(QIODevice::WriteOnly|QIODevice::Append))
    {
        ...
        QMessageBox::critical(0, QString("DLT Viewer"),
                              ...
                              .arg(outputfile.errorString()));
#ifdef XWBLOG
    qDebug() << "xwb:MainWindow::onSaveAsTriggered after";
#endif
}
...
{
#ifdef XWBLOG
    qDebug() << "xwb:MainWindow::reloadLogFileFinishIndex before" << __FILE__ << __LINE__;
#endif
    ...
    restoreSelection();
#ifdef XWBLOG
    qDebug() << "xwb:MainWindow::reloadLogFileFinishIndex after" << __FILE__ << __LINE__;
#endif
}
...
{
#ifdef XWBLOG
    qDebug() << "xwb:MainWindow::reloadLogFileFinishFilter before" << __FILE__ << __LINE__;
#endif
    // unlock table view
    //ui->tableView->unlock();
...
#ifdef XWBLOG
    qDebug() << "xwb:MainWindow::reloadLogFileFinishFilter after" << __FILE__ << __LINE__;
#endif
}
...
void MainWindow::reloadLogFile(bool update, bool multithreaded)
{
    ...
    tableModel->modelChanged();
#ifdef XWBLOG
    qDebug() << "xwb:MainWindow::reloadLogFile before. update =" << update << "multithreaded =" << multithreaded << __FILE__ << __LINE__;
#endif
...
#ifdef XWBLOG
    qDebug() << "xwb[import]:MainWindow::reloadLogFile openFileNamessize =" << openFileNames.size() << __FILE__ << __LINE__;
#endif
    // open qfile
    if( false == update)
    {
...
#ifdef XWBLOG
    qDebug() << "xwbtest[breakpoint]:MainWindow::reloadLogFile";
    //QThread::sleep(5000);
#endif
...
#ifdef XWBLOG
    qDebug() << "xwb[import]:MainWindow::reloadLogFile multithreaded =" << multithreaded << __FILE__ << __LINE__;
#endif
...
#ifdef XWBLOG
    qDebug() << "xwb:MainWindow::reloadLogFile after." << __FILE__ << __LINE__;
#endif
}
...
{
#ifdef XWBLOG
    qDebug() << "xwb:mainwindow applySettings before" << __FILE__ << __LINE__;
#endif
...
#ifdef XWBLOG
    qDebug() << "xwb:mainwindow applySettings after" << __FILE__ << __LINE__;
#endif
}
...
{
#ifdef XWBLOG
    qDebug() << "xwb:mainwindow::openDlpFile before" << __FILE__ << __LINE__;
#endif
...
#ifdef XWBLOG
    qDebug() << "xwb:mainwindow::openDlpFile after" << __FILE__ << __LINE__;
#endif
}
...
{
#ifdef XWBLOG
     qDebug() << "xwb:before on_configWidget_customContextMenuRequested" << __FILE__ << __LINE__;
#endif
...
#ifdef XWBLOG
     qDebug() << "xwb:after on_configWidget_customContextMenuRequested" << __FILE__ << __LINE__;
#endif
}
...
#ifdef XWBLOG
    qDebug() << "xwb:MainWindow::read before" << __FILE__ << __LINE__;
#endif
    switch (ecuitem->interfacetype)
     {
      case EcuItem::INTERFACETYPE_TCP:
...
#ifdef XWBLOG
    qDebug() << "xwb:MainWindow::read after" << __FILE__ << __LINE__;
#endif
}
...
{
#ifdef XWBLOG
    qDebug() << "xwb:MainWindow::SplitTriggered before";
#endif
    // change DLT file working directory
    workingDirectory.setDltDirectory(QFileInfo(fileName).absolutePath());
...
#ifdef XWBLOG
    qDebug() << "xwb:MainWindow::SplitTriggered after";
#endif
 }
...
#ifdef XWBLOG
    qDebug() << "xwb:MainWindow::updateIndex before" << __FILE__ << __LINE__;
#endif
...
#ifdef XWBLOG
    qDebug() << "xwb:MainWindow::updateIndex after" << __FILE__ << __LINE__;
#endif
}
...
#ifdef XWBLOG
    qDebug() << "xwb:MainWindow::updateRecentFileActions before,numRecentFiles =" << numRecentFiles << __FILE__ << __LINE__;
#endif
...
#ifdef XWBLOG
    qDebug() << "xwb:MainWindow::updateRecentFileActions after" << __FILE__ << __LINE__;
#endif
}
...
{
#ifdef XWBLOG
    qDebug() << "xwb:MainWindow::setCurrentFile before" << __FILE__ << __LINE__;
#endif
...
#ifdef XWBLOG
    qDebug() << "xwb:MainWindow::setCurrentFile after" << __FILE__ << __LINE__;
#endif
}
...
{
#ifdef XWBLOG
    qDebug() << "xwb:MainWindow::removeCurrentFile before" << __FILE__ << __LINE__;
#endif
    recentFiles.removeAll(fileName);
    updateRecentFileActions();
...
{
#ifdef XWBLOG
    qDebug() << "xwb:before MainWindow::loadPlugins" << __FILE__ << __LINE__;
#endif
...
#ifdef XWBLOG
    qDebug() << "xwb:after MainWindow::loadPlugins" << __FILE__ << __LINE__;
#endif
}
...
{
#ifdef XWBLOG
    qDebug() << "xwb:before MainWindow::on_exploreView_customContextMenuRequested" << __FILE__ << __LINE__;
#endif
    ...
    menu.exec(globalPos);
#ifdef XWBLOG
    qDebug() << "xwb:after MainWindow::on_exploreView_customContextMenuRequested" << __FILE__ << __LINE__;
#endif
}
...
{
#ifdef XWBLOG
    qDebug() << "xwb:MainWindow::on_tableView_SearchIndex_customContextMenuRequested before" << __FILE__ << __LINE__;
#endif
    ...
    menu.exec(globalPos);
#ifdef XWBLOG
    qDebug() << "xwb:MainWindow::on_tableView_SearchIndex_customContextMenuRequested after" << __FILE__ << __LINE__;
#endif
}
...
{
#ifdef XWBLOG
    qDebug() << "xwb:MainWindow::keyPressEvent before" << __FILE__ << __LINE__;
    qDebug() << "xwb:MainWindow::keyPressEvent evet-key = " << event->key() << __FILE__ << __LINE__;
#endif
...
#ifdef XWBLOG
    qDebug() << "xwb:MainWindow::keyPressEvent after" << __FILE__ << __LINE__;
#endif
}
...
{
#ifdef XWBLOG
    qDebug() << "xwb:mainwindow::dropEvent before. Size = " << event->mimeData()->urls().size() << __FILE__ << __LINE__;
#endif
...
#ifdef XWBLOG
    qDebug() << "xwb:mainwindow::dropEvent endsWith dlt = " << filename.endsWith(".dlt", Qt::CaseInsensitive);
    qDebug() << "xwb:mainwindow::dropEvent endsWith dlp = " << filename.endsWith(".dlp", Qt::CaseInsensitive);
    qDebug() << "xwb:mainwindow::dropEvent endsWith dlf = " << filename.endsWith(".dlf", Qt::CaseInsensitive);
#endif
...
#ifdef XWBLOG
    qDebug() << "xwb:mainwindow::dropEvent after" << __FILE__ << __LINE__;
#endif
}
...
{
#ifdef XWBLOG
    qDebug() << "MainWindow::nearest_line before.line = " << line << "qfilesize = " << qfile.size();
#endif
    ...
    qDebug() << "MainWindow[xwbadd]::nearest_line after.return row = " << row;
#ifdef XWBLOG
    qDebug() << "MainWindow[xwbadd]::nearest_line after.return allfilesize = " << qfile.getNumberOfFiles();
#endif
    int currentsizecnt = 0;
    for(int fileidx = 0; fileidx < qfile.getNumberOfFiles(); fileidx++)
    {
        currentsizecnt += qfile.getFileMsgNumber(fileidx);
        if(line <= currentsizecnt)
        {
            //qDebug() << "MainWindow::nearest_line after.filename =" << qfile.getFileName(fileidx);

            // find the file and set name of opened log file in status bar
            QFontMetrics fm = QFontMetrics(statusFilename->font());
            QString name = qfile.getFileName(fileidx);
            statusFilename->setMinimumWidth(1); // this is the rollback of the workaround for first call
                                                // with value "1" the window can be reduced in width
            statusFilename->setText(fm.elidedText(name, Qt::ElideLeft, statusFilename->width()));
            statusFilename->setToolTip(name);
...
{
#ifdef XWBLOG
    qDebug() << "xwb:MainWindow::jump_to_line before.line = " << line;
#endif
    /*There is a problem with this return value (row).
     *If you don't add index without normal parsing*/
    int row = nearest_line(line);
    int column = -1;
    if (0 > row)
    {
        qDebug() << "ERROR:MainWindow::jump_to_line row<0，row is" << row;
        return false;
    }
    ...
    /* must be row.(may be error,use line will accuracy)*/
    ...
    tableModel->setLastSearchIndex(row);

#ifdef XWBLOG
    qDebug() << "MainWindow::jump_to_line after. idx = " << idx;
#endif
    return true;
}
...
{
#ifdef XWBLOG
    qDebug() << "MainWindow::restoreSelection before";
#endif
    int firstIndex = 0;
...
#ifdef XWBLOG
    qDebug() << "MainWindow::restoreSelection after";
#endif
}
...
{
#ifdef XWBLOG
    qDebug() << "xwb:MainWindow::on_tabWidget_currentChanged before,index =" << index << __FILE__ << __LINE__;
#endif
    if(index > 1)
    {
...
#ifdef XWBLOG
    qDebug() << "xwb:MainWindow::on_tabWidget_currentChanged after" << __FILE__ << __LINE__;
#endif
}
...
void MainWindow::searchtable_cellSelected( QModelIndex index)
{
    ...
    unsigned long entry;
#ifdef XWBLOG
    qDebug() << "MainWindow::searchtable_cellSelected before. index" << index << "position =" << position;
#endif
...
#ifdef XWBLOG
    qDebug() << "MainWindow::searchtable_cellSelected after.";
#endif
}
...
{
#ifdef XWBLOG
    qDebug() << "xwb:before getPathFromExplorerViewIndexModel" << __FILE__ << __LINE__;
#endif
    QSortFilterProxyModel*   proxyModel = reinterpret_cast<QSortFilterProxyModel*>(ui->exploreView->model());
    QFileSystemModel*        fsModel    = reinterpret_cast<QFileSystemModel*>(proxyModel->sourceModel());
    QString                  path       = fsModel->filePath(proxyModel->mapToSource(index));
#ifdef XWBLOG
    qDebug() << "xwb:after getPathFromExplorerViewIndexModel" << __FILE__ << __LINE__;
#endif
...
{
#ifdef XWBLOG
    qDebug() << "xwb:before on_exploreView_activated" << __FILE__ << __LINE__;
#endif
...
#ifdef XWBLOG
    qDebug() << "xwb:after on_exploreView_activated" << __FILE__ << __LINE__;
#endif
}
...
{
#ifdef XWBLOG
    qDebug() << "xwb:before on_comboBoxExplorerSortType_currentIndexChanged"<<index << __FILE__ << __LINE__;
#endif
    switch (index)
    {
    case 1:
...
#ifdef XWBLOG
    qDebug() << "xwb:after on_comboBoxExplorerSortType_currentIndexChanged" << __FILE__ << __LINE__;
#endif
}
...
{
#ifdef XWBLOG
    qDebug() << "xwb:before on_comboBoxExplorerSortOrder_currentIndexChanged"<<index << __FILE__ << __LINE__;
#endif
    switch (index)
    {
    case 1:
...
#ifdef XWBLOG
    qDebug() << "xwb:after on_comboBoxExplorerSortOrder_currentIndexChanged" << __FILE__ << __LINE__;
#endif
}
